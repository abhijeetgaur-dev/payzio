...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-800">Completed Settlements</h1>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900 dark:text-white">
                                        {{ $settlement['vendor_name'] }}</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">Vendor ID:
                                        {{ $settlement['vendor_id'] }}</div>
                                </td>
