            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
                ...
                <div class="flex space-x-3">
                    <select id="vendor-filter"
                        class="px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700">
                        <option value="">All Vendors</option>
                        <option value="mohan">Mohan Grocery</option>
                        <option value="suresh">Suresh Electronics</option>
                        <option value="priya">Priya Fashion</option>
                        <option value="raju">Raju Kirana</option>
                    </select>
