        ...
        @if ($showStats)
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $thisMonthTransactionsCount }}
                            </p>
                        </div>
                    ...
                    <p
                        class="text-xs {{ $transactionChange >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} mt-2">
                        <i class="fas {{ $transactionChange >= 0 ? 'fa-arrow-up' : 'fa-arrow-down' }} mr-1"></i>
                        {{ abs($transactionChange) }}% from last month
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                    ...
                    <p
                        class="text-xs {{ $amountChange >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} mt-2">
                        <i class="fas {{ $amountChange >= 0 ? 'fa-arrow-up' : 'fa-arrow-down' }} mr-1"></i>
                        {{ abs($amountChange) }}% from last month
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                    ...
                    <p
                        class="text-xs {{ $commissionChange >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }} mt-2">
                        <i class="fas {{ $commissionChange >= 0 ? 'fa-arrow-up' : 'fa-arrow-down' }} mr-1"></i>
                        {{ abs($commissionChange) }}% from last month
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800 dark:text-white">
                                ₹{{ $thisMonthTransactionsCount > 0 ? number_format($thisMonthAmount / $thisMonthTransactionsCount, 2) : '0.00' }}
                            </p>
                        </div>
                    ...
                    {{-- You can add logic for avg transaction change if desired --}}
