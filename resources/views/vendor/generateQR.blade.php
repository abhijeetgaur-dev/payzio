                    ...
                    <form id="qr-form">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                <p class="font-medium text-gray-800 dark:text-white">{{ auth('vendor')->user()->business_name }}</p>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div id="qr-code-display"
                                ...
                                <div class="mt-4 text-center">
                                    <p id="vendor-name-display" class="text-sm font-medium text-gray-900 dark:text-gray-100"></p>
                                    <p id="vendor-email-display" class="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-xs truncate"></p>
                                    <p id="vendor-phone-display" class="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-xs truncate"></p>
                                    <p id="description-display" class="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-xs truncate"></p>
                                </div>
                            </div>
            ...
            document.getElementById('save-btn').addEventListener('click', function() {
                ...
                html2canvas(qrDisplay).then(canvas => {
                    canvas.toBlob(function(blob) {
                        ...
                        formData.append('description', vendor.id);
                        formData.append('qr_image', blob, `qr-${vendor.id}-${Date.now()}.png`);
